"""Test script for Cyperf Network Profile API."""
...
def main() -> None:
    """Main function to test Cyperf Network Profile API."""
    try:
        ...
        result = cyperf_network_profile.get_dut_segments_details(
            session_id="appsec-f949b112-6059-42dd-9e4c-2cdd67739b75"
        )
        print(result)
        ...
        print(result)
        result = cyperf_network_profile.add_ip_network_segment(
            session_id="appsec-f949b112-6059-42dd-9e4c-2cdd67739b75",
        ...
        print(result)
        cyperf_network_profile.add_dut_network_segment(
            session_id="appsec-f949b112-6059-42dd-9e4c-2cdd67739b75",
            dut_segment_name="DUT Network 71",
            dut_segment_id="71"
        )
        result = cyperf_network_profile.get_network_profiles_details(
            session_id="appsec-f949b112-6059-42dd-9e4c-2cdd67739b75"
        )
        print(result)
