...
def main():
    ...
    result = cyperf_objectives.get_all_primary_objectives_goals(session_id="appsec-d09bc450-8472-4e9c-9573-5859ae5ced57")
    result = cyperf_objectives.get_all_secondary_objectives_goals(session_id="appsec-d09bc450-8472-4e9c-9573-5859ae5ced57")
    result = cyperf_objectives.set_primary_objective_goals(session_id="appsec-d09bc450-8472-4e9c-9573-5859ae5ced57", 
